...
#
    ...
    ["Parrot 07"]="debian|bullseye|https://deb.parrot.sh/parrot/iso/7.1/Parrot-home-7.1_amd64.qcow2|debian11|debian|debian"
    ["Parrot 07"]="debian|bookworm|https://deb.parrot.sh/parrot/iso/7.1/Parrot-home-7.1_amd64.qcow2|debian12|debian|debian"
