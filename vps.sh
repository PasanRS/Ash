...
create_new_vm() {
    ...
    while true; do
        read -p "$(print_status "INPUT" "Memory in MB (default: 49152): ")" MEMORY
        MEMORY="${MEMORY:-49152}"
...
#    ["Parrot"]="https://deb.parrot.sh/parrot/iso/7.1/Parrot-home-7.1_amd64.qcow2|debian11|debian|debian"
    ["Ubuntu 22.04"]="ubuntu|jammy|https://cloud-images.ubuntu.com/jammy/current/jammy-server-cloudimg-amd64.img|ubuntu22|ubuntu|ubuntu"
    ["Ubuntu 24.04"]="ubuntu|noble|https://cloud-images.ubuntu.com/noble/current/noble-server-cloudimg-amd64.img|ubuntu24|ubuntu|ubuntu"
    ["Debian 11"]="debian|bullseye|https://deb.parrot.sh/parrot/iso/7.1/Parrot-home-7.1_amd64.qcow2|debian11|debian|debian"
    ["Debian 12"]="debian|bookworm|https://deb.parrot.sh/parrot/iso/7.1/Parrot-home-7.1_amd64.qcow2|debian12|debian|debian"
